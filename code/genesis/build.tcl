namespace eval genesis {
    proc build {{&pinfo} {&tconfig} args} {
        ...
        if {$tconfig(compiler) == "tcc"} {
            set {compiler opts} "-Icode -I${project dir}/third_party ${project dir}geometry_compiler.c ${project dir}third_party/zip/src/zip.c ${project dir}third_party/libxml2d.dll -o build/genesis.exe"
        } else {
